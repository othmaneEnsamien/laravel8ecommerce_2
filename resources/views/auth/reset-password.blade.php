							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{ route('password.update') }}" name="frm-login" method="POST" >
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-reg-email" name="email" placeholder="Email address" :value="old('email', $request->email)" required autofocus >
									</fieldset>
                                    ...
                                    <input type="submit" class="btn btn-sign" value=" {{ __('Reset Password') }}" >
								</form>
							</div>											
						</div>
